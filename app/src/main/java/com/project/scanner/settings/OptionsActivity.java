...
public class OptionsActivity extends AppCompatPreferenceActivity {
    ...
    public void onBuildHeaders(List<Header> target) {
        loadHeadersFromResource(R.xml.pref_options, target);
    }
    ...
    /**
     * This fragment shows history only. It is used when the
    ...
    public static class SettingsPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            if (preferenceManager.getSharedPreferences().getBoolean("settings_beep", true)){
                // Your switch is on
            } else {
                // Your switch is off
            }
